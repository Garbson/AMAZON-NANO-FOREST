    ...
    <header class="relative flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-transparent text-sm py-4 dark:bg-gray-800">
      <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
        <div class="flex items-center justify-between">
          <a class="flex-none text-xl font-semibold" href="#"> <img src="img/gold.png" alt="" class="h-32 w-auto" /></a>
          <div class="sm:hidden">
            <button
              type="button"
        ...
        <div id="navbar-with-mega-menu" class="hs-collapse overflow-hidden transition-all duration-300 basis-full grow sm:block">
          <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
            <a
              class="font-bold text-md text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="#about"
              aria-current="page"
              >Sobre Nós</a
            >
            <a
              class="font-bold text-md text-white hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              href="#equipe"
              >Nossa Equipe</a
            >
            ...
            <div class="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none]">
              <button
                ...
                type="button"
                class="flex text-md items-center w-full text-white hover:text-gray-400 font-bold dark:text-gray-400 dark:hover:text-gray-500"
              >
                Empresas
                <svg
              ...
              >
                ...
                <div class="hs-dropdown relative [--strategy:static] sm:[--strategy:absolute] [--adaptive:none]">
                  ...
                  >
                    Sub Menu
                    <svg
                      class="sm:-rotate-90 ms-2 flex-shrink-0 w-4 h-4 text-gray-600"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
